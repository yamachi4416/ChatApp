...
namespace ChatApp.Test.IntegrationTests
{
    ...
    {
        public AccountTest(TestFixture fixture) : base(fixture, "/Account")
        {
        }
        ...
        public async void Account_Google_ExternalLoginCallback_UserLogin_Success()
        {
            ...
            var createdUser = await fixture.DbContext.Users
                .AsNoTracking()
            ...
            var userLogin = await fixture.DbContext.UserLogins
                .AsNoTracking()
