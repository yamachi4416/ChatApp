        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedById = table.Column<string>(maxLength: 128, nullable: false),
                    CreatedDate = table.Column<DateTimeOffset>(nullable: false),
                    Description = table.Column<string>(maxLength: 255, nullable: true),
                    Name = table.Column<string>(maxLength: 30, nullable: false),
                    UpdatedById = table.Column<string>(maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ChatRoomAvatars",
                columns: table => new
                {
                    ChatRoomId = table.Column<Guid>(nullable: false),
                    Content = table.Column<byte[]>(maxLength: 100000, nullable: false),
                    ContentType = table.Column<string>(maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatRoomAvatars", x => x.ChatRoomId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<byte[]>(maxLength: 50000, nullable: false),
                    ContentType = table.Column<string>(maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
